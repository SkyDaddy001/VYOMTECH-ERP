        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-indigo-50 rounded-lg p-4 border-l-4 border-indigo-500">
              ...
              <p className="text-4xl font-bold text-indigo-600">{((netProfit / totalAssets) * 100).toFixed(1)}%</p>
      ...
      content: (
        <div className="space-y-4">
          <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
            ...
            <p className="text-gray-700 text-sm">Healthy current ratio indicates good short-term liquidity position.</p>
          </div>
          <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg">
            <p className="font-bold text-green-900 mb-2">✓ Excellent Profitability</p>
            <p className="text-gray-700 text-sm">Strong net profit margin shows excellent operational efficiency.</p>
          </div>
          <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-lg">
            <p className="font-bold text-blue-900 mb-2">📊 Balanced Capital Structure</p>
            <p className="text-gray-700 text-sm">Conservative financial leverage with healthy debt-to-equity ratio.</p>
          </div>
