      ...
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3 px-4 bg-blue-800 hover:bg-blue-900 disabled:bg-blue-700 text-white font-semibold rounded-lg transition duration-200 flex items-center justify-center gap-2"
          >
            {loading ? (
              <>
                <span className="inline-block animate-spin">⟳</span>
        ...
        <p className="text-center text-sm text-gray-600 mt-6">
          Secure OAuth authentication powered by Prisma
        </p>
      </div>
    </div>
  );
