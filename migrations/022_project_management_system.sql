...
ADD COLUMN IF NOT EXISTS `sbua` DECIMAL(15,2) COMMENT 'Super Built-Up Area',
ADD COLUMN IF NOT EXISTS `rate_per_sqft` DECIMAL(15,2),
ADD COLUMN IF NOT EXISTS `car_parking_cost` DECIMAL(18,2),
ADD COLUMN IF NOT EXISTS `plc` DECIMAL(18,2) COMMENT 'PLC charges if any',
ADD COLUMN IF NOT EXISTS `statutory_approval_charge` DECIMAL(18,2) COMMENT 'Local body, infrastructure, incidental charges',
...
ADD COLUMN IF NOT EXISTS `other_charges_1` DECIMAL(18,2) COMMENT 'Charge amount (per sqft or lump-sum based on config)',
ADD COLUMN IF NOT EXISTS `other_charges_1_name` VARCHAR(100),
ADD COLUMN IF NOT EXISTS `other_charges_1_type` VARCHAR(20) COMMENT 'PER_SQFT or LUMPSUM',
ADD COLUMN IF NOT EXISTS `other_charges_2` DECIMAL(18,2),
ADD COLUMN IF NOT EXISTS `other_charges_2_name` VARCHAR(100),
ADD COLUMN IF NOT EXISTS `other_charges_2_type` VARCHAR(20) COMMENT 'PER_SQFT or LUMPSUM',
ADD COLUMN IF NOT EXISTS `other_charges_3` DECIMAL(18,2),
ADD COLUMN IF NOT EXISTS `other_charges_3_name` VARCHAR(100),
ADD COLUMN IF NOT EXISTS `other_charges_3_type` VARCHAR(20) COMMENT 'PER_SQFT or LUMPSUM',
ADD COLUMN IF NOT EXISTS `other_charges_4` DECIMAL(18,2),
ADD COLUMN IF NOT EXISTS `other_charges_4_name` VARCHAR(100),
ADD COLUMN IF NOT EXISTS `other_charges_4_type` VARCHAR(20) COMMENT 'PER_SQFT or LUMPSUM',
ADD COLUMN IF NOT EXISTS `other_charges_5` DECIMAL(18,2),
ADD COLUMN IF NOT EXISTS `other_charges_5_name` VARCHAR(100),
ADD COLUMN IF NOT EXISTS `other_charges_5_type` VARCHAR(20) COMMENT 'PER_SQFT or LUMPSUM',
ADD COLUMN IF NOT EXISTS `apartment_cost_excluding_govt` DECIMAL(18,2) COMMENT 'Cost excluding government charges',
ADD COLUMN IF NOT EXISTS `actual_sold_price_excluding_govt` DECIMAL(18,2) COMMENT 'Selling price excluding government charges',
...
ADD COLUMN IF NOT EXISTS `other_charges_json` JSON COMMENT 'JSON store for flexible additional charges',
