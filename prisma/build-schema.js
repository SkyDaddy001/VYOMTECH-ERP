...
console.log('🔨 Prisma Schema Composer');
console.log('='.repeat(50));

// Get all schema files in order (numeric sort to maintain module order)
...
console.log(`\n📂 Found ${schemaFiles.length} schema files (including new Call Center module)`);
