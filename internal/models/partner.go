...
type PartnerLead struct {
	...
	TenantID        string     `json:"tenant_id" db:"tenant_id"`
	PartnerID       int64      `json:"partner_id" db:"partner_id"`
	LeadID          *int64     `json:"lead_id" db:"lead_id"` // FK to actual lead (if approved)
	...
	SubmittedBy     int64      `json:"submitted_by" db:"submitted_by"` // Partner user ID
...
type PartnerPayoutDetail struct {
	ID               int64      `json:"id" db:"id"`
	PayoutID         int64      `json:"payout_id" db:"payout_id"`
	PartnerLeadID    int64      `json:"partner_lead_id" db:"partner_lead_id"`
	LeadSubmissionID int64      `json:"lead_submission_id" db:"lead_submission_id"`
